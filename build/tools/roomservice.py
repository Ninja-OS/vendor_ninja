...
DEBUG = False
default_manifest = ".repo/manifests/ninja_default.xml"
custom_local_manifest = ".repo/local_manifests/ninja_manifest.xml"
custom_default_revision = "oreo-mr1"
custom_dependencies = "ninja.dependencies"
org_manifest = "NINJA-Devices"  # leave empty if org is provided in manifest
org_display = "NINJA-Devices"  # needed for displaying
